	...
	["Su-17M4"] = {--1967 (primo volo) 1972 (entrata in servizio)
		...
		["Strike"] = {			
			...
			["CAS Bombs"] = {
				...
				attributes = {"soft","Parked Aircraft", "Structure", "Bridge"},
				weaponType = "Bombs",
				expend = "All",
				attackType = "Dive",
				day = true,
	...
	["MiG-27K"] = {--1970 (primo volo) 1975 (entrata in servizio) -- Bombe?
		...
		["Strike"] = {
			["Kh-29T*2, R-60*2, FT"] = {
				...
				attributes = {"SAM", "Structure", "Bridge", "hard"},
				weaponType = "ASM",
				expend = "All",
				attackType = "Dive",
				day = true,
			...
			["CAS Cluster Bombs sparse light"] = {
				minscore = 0.3,
				support = {
						["Escort"] = true,
						["SEAD"] = false,
