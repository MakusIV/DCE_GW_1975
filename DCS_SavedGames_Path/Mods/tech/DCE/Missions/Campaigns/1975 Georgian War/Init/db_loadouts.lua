	...
	["F-14A-135-GR"] = { --1970 (primo volo) 1974 (entrata in servizio),
		["Intercept"] = {
			["TF-Old-AIM-54A-MK60*4, AIM-7M*2, AIM-9M*2, XT*2"] = {
				...
				range = 500000,
				capability = 9,
				firepower = 8, -- = evaluate_weapon_firepower(weapon = "AIM-54A-MK60", quantity = 4) + evaluate_weapon_firepower(weapon = "AIM-7M", quantity = 2) + evaluate_weapon_firepower(weapon = "AIM-9M", quantity = 2)
				vCruise = nil,
				vAttack = nil,
				hCruise = nil,
				hAttack = nil,
		...
		["CAP"] = {
			["TF-Old-AIM-54A-MK60*4, AIM-7M*2, AIM-9M*2, XT*2"] = {
				...
				range = 500000,
				capability = 8,
				firepower = 8,  -- = evaluate_weapon_firepower(weapon = "AIM-54A-MK60", quantity = 4) + evaluate_weapon_firepower(weapon = "AIM-7M", quantity = 2) -- solo BVR(?)
	...
	["AJS37"] = {-- 1971 (entrata in servizio)
		...
		["Anti-ship Strike"] = {
			...
			["Antiship ECM Escort KB pod RB-04R*1RB-74*2, FUEL"] = {
				...
				hCruise = 17000, --3500,
				hAttack = 17000,
				standoff = 30000, --rb04 range: 32000 
				tStation = nil,
				LDSD = false,
				self_escort = false,
				sortie_rate = 3,
	...
	["MiG-27K"] = {--1970 (primo volo) 1975 (entrata in servizio) -- Bombe?
		...
		["Strike"] = {			
			["GA Kh-25MPR*2 R-60M*2 Fuel"] = {
				...
				hCruise = 5500,
				hAttack = 2000,
				standoff = 6000,-- Kh-25MPR infrared 20 km !?
				tStation = nil,
				LDSD = false,
				self_escort = false,
				sortie_rate = 6,
			...
			["GA Kh-25MPL*2 R-60M*2 Fuel"] = {
				...
				hCruise = 5500,
				hAttack = 2000,
				standoff = 6000, -- Kh-25MPL Laser 11 km
				tStation = nil,
				LDSD = false,
				self_escort = false,
				sortie_rate = 3,
