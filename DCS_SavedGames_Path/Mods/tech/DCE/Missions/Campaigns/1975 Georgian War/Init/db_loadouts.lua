...
["MiG-21Bis"] = {														--String, aircraft type
	["Strike"] = {														--String, task
		["Custom Loadout Name"] = {										--String, custom loadout name
			...
			firepower = 10,												--Number, how much firepower has this loadout. The higher the better  (note: level threat = capability * firepower * one third of ready aircraft)
	...
	["S-3B"] = { --1972 (primo volo) 1974 (entrata in servizio)
		...
		["Strike"] = {
			["GA MK-84*2, MK-82*4"] = {
				...
				attributes = {"soft", "Structure", "Bridge", "SAM"},
				weaponType = "Bombs",
				expend = "All",
				day = true,
				night = false,
