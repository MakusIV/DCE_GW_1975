...
-- Miguel21 modification M11.r : Multiplayer (r: targets already destroyed)(q: displays all tasks of several squadrons)
...
log.outfile = "Log/LOG_BAT_SkipMission." .. camp.mission .. ".txt.lua" -- "prova Log.LOG_DEVRIEF_Master"
...
if input == "y" or input == "yes" then	
	...
	repeat	
		...
		repeat
			...
			dofile("Active/camp_status.lua")
			camp.versionPackageICM = tostring(versionPackageICM)											-- Miguel21 modification M35 version ScriptsMod -- ajoute la version du script dans camp_status pour utilisation en fin de mission																				--set amount of players
